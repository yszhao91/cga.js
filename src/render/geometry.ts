...
import { BufferAttribute, Uint32BufferAttribute } from "./buffer-attribute";
...
export class BufferGeometry {
    ...
    setIndex(index: BufferAttribute | number[]) {
        ...
        if (Array.isArray(index)) {
            this.index = new (Vec.max(index) > 65535 ? Uint32BufferAttribute : Uint32BufferAttribute)(index, 1);
    ...
    applyMatrix4(matrix:Mat4) {
        ...
        if (position !== undefined) {
            ...
            position.applyMatrixrix4(matrix);
