...
*/
var cga = (function (earcut, mesh$1, Line, type$1) {
	'use strict';

	earcut = earcut && Object.prototype.hasOwnProperty.call(earcut, 'default') ? earcut['default'] : earcut;
	mesh$1 = mesh$1 && Object.prototype.hasOwnProperty.call(mesh$1, 'default') ? mesh$1['default'] : mesh$1;
	Line = Line && Object.prototype.hasOwnProperty.call(Line, 'default') ? Line['default'] : Line;
	type$1 = type$1 && Object.prototype.hasOwnProperty.call(type$1, 'default') ? type$1['default'] : type$1;
	...
	function () {
	  ...
	  Line.prototype.orientationPoint = function (point, normal) {
	    ...
	    if (!Number.isNaN(_distance) && _distance < _Math.gPrecision) return type.Orientation.Common;
	    return point.clone().sub(this.origin).dot(_binormal) > 0 ? type.Orientation.Positive : type.Orientation.Negative;
	  };
	...
	var earcut_1 = __importDefault(earcut);
	...
	var convexHull = createCommonjsModule(function (module, exports) {
	...
	function () {
	  ...
	  function ConvexHull(pts, options) {
	    ...
	    var _newPoints = common.clone(pts);

	    mesh$1.indexable(_newPoints);
	    ...
	    if (_planeNormal) {
	      ...
	      _newPoints.forEach(function (pt) {
	        return pt.z = 0;
	      });

	      var _a = this.getMinMax(_newPoints),
	          minPt = _a[0],
	          maxPt = _a[1];

	      var line0 = new Line.Line(minPt, maxPt),
	          line1 = new Line.Line(maxPt, minPt);
	  ...
	  ConvexHull.prototype.getMinMax = function (points) {
	    ...
	    for (var i = 1; i < points.length; i++) {
	      var pt = points[i];
	      if (maxXp.x < pt.x) maxXp = pt;else if (minXp.x > pt.x) minXp = pt;
	    }
	  ...
	  ConvexHull.prototype.addBoundSeg = function (line, points) {
	    ...
	    points.forEach(function (pt) {
	      if (line.orientationPoint(pt, _this._normal) === type$1.Orientation.Positive) {
	  ...
	  Object.defineProperty(ConvexHull.prototype, "hull", {
	    ...
	    get: function () {
	      if (this._hull.length === 0 && this._originPoints) {
	        return common.clone(this._originPoints);
	      }
	...
	unwrapExports(convexHull);
	var convexHull_1 = convexHull.quickHull;
	var convexHull_2 = convexHull.ConvexHull;
	...
	__exportStar(convexHull, exports);
